    ...
    <div className="space-y-4">
      ...
      {availableProviders.google && (
        <button
          ...
          className="w-full h-12 bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-medium rounded-lg flex items-center justify-center gap-3 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
        >
      ...
      {availableProviders.facebook && (
        <button
          ...
          className="w-full h-12 bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-medium rounded-lg flex items-center justify-center gap-3 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2"
        >
      ...
      {availableProviders.twitter && (
        <button
          type="button"
          onClick={(e) => {
            console.log('🎯 BUTTON CLICKED - Twitter', e);
            e.preventDefault();
            e.stopPropagation();
            handleTwitterLogin();
          }}
          className="w-full h-12 bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-medium rounded-lg flex items-center justify-center gap-3 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2"
        >
