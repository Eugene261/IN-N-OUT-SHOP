                      ...
                      featuredProducts.map((product) => (
                        ...
                        >
                          <div className="flex items-center space-x-3">
                            <div className="h-12 w-12 bg-gray-100 rounded-md overflow-hidden flex-shrink-0">
                              {product.images && product.images.length > 0 ? (
                                ...
                                <Box className="h-full w-full p-2 text-gray-400" />
                              )}
                            </div>
                          ...
                          <button
                            ...
                            className={`p-2 rounded-full ${product.bestseller ? 'bg-yellow-100 text-yellow-600' : 'bg-gray-100 text-gray-400'} hover:bg-yellow-200 transition-colors`}
                          >
                      ...
                      featuredProducts.map((product) => (
                        ...
                        >
                          ...
                          <button
                            ...
                            className={`p-2 rounded-full ${product.newArrival ? 'bg-blue-100 text-blue-600' : 'bg-gray-100 text-gray-400'} hover:bg-blue-200 transition-colors`}
                          >
