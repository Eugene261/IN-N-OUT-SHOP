...
const SuperAdminDashboard = () => {
  ...
  // Hardcoded order statuses for demonstration
  const [demoOrderStats] = useState({
    pending: 0,
    processing: 8,
    confirmed: 0,
    shipped: 0,
  ...
  // Hardcoded admin revenue for demonstration
  const [demoAdminRevenue] = useState([
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {demoAdminRevenue.map((admin, index) => (
