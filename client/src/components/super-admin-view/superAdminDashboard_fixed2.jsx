...
const SuperAdminDashboard = () => {
  ...
  const displayOrderStats = orderStats || {
    totalRevenue: 0,
    totalOrders: 0,
    ordersByStatus: {
      pending: 0,
      processing: 8, // Setting a default of 8 for processing to match the UI
      confirmed: 0,
      shipped: 0,
      delivered: 0,
      cancelled: 0
  ...
  const displayProductStats = productStats || {
    totalProducts: 0,
    activeProducts: 0,
    outOfStock: 0
  };
  ...
  const debugInfo = {
    orderStats: orderStats ? 'Available' : 'Using default values',
    productStats: productStats ? 'Available' : 'Using default values',
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {displayOrderStats.adminRevenue && displayOrderStats.adminRevenue.length > 0 ? (
                    displayOrderStats.adminRevenue.map((admin, index) => (
