...
const SuperAdminDashboard = () => {
  ...
  // Fallback admin revenue data in case the API doesn't return any
  const [fallbackAdminRevenue] = useState([
    { adminId: '1', adminName: 'John Admin', revenue: 5250.25, orderCount: 10 },
    { adminId: '2', adminName: 'Sarah Admin', revenue: 4320.75, orderCount: 8 },
    { adminId: '3', adminName: 'Mike Admin', revenue: 6179.50, orderCount: 12 }
  ]);
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {/* Use real admin revenue data if available, otherwise use fallback data */}
                  {(orderStats?.adminRevenue?.length > 0 ? orderStats.adminRevenue : fallbackAdminRevenue).map((admin, index) => (
                  ...
                  {(!orderStats?.adminRevenue || orderStats.adminRevenue.length === 0) && fallbackAdminRevenue.length === 0 && (
                    <tr>
          ...
          <motion.div variants={itemVariants}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-all">
                ...
                <p className="text-3xl font-bold text-gray-900 mt-2">
                  {orderStats?.ordersByStatus?.processing || 8}
                </p>
