...
const SuperAdminDashboard = () => {
  ...
  const sampleOrderStats = {
    ...
    adminRevenue: [
      { adminId: '1', adminName: 'John Admin', revenue: 5250.25, orderCount: 10 },
      { adminId: '2', adminName: 'Sarah Admin', revenue: 4320.75, orderCount: 8 },
      { adminId: '3', adminName: 'Mike Admin', revenue: 6179.50, orderCount: 10 }
    ]
  };
  ...
  useEffect(() => {
    ...
    dispatch(fetchOrderStats())
      .then(response => {
        ...
        // If no data is returned, we'll use sample data
      })
  ...
  const displayOrderStats = orderStats || sampleOrderStats;
  const displayProductStats = productStats || sampleProductStats;
  
  // Add a debug section to display state
  const debugInfo = {
    orderStats: orderStats ? 'Available' : 'Using sample data',
    productStats: productStats ? 'Available' : 'Using sample data',
    adminUsers: adminUsers.length > 0 ? `${adminUsers.length} admins found` : 'No admins found',
    isLoading,
  ...
  return (
    ...
    >
      ...
      {/* Debug Information */}
      <motion.div variants={itemVariants} className="mb-8 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
        <h2 className="text-lg font-semibold text-yellow-800 mb-2">Debug Information</h2>
        <pre className="text-sm bg-white p-3 rounded border border-yellow-200 overflow-auto">
          ...
          >
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-all">
              ...
              <p className="text-3xl font-bold text-gray-900 mt-2">
                {formatCurrency(displayOrderStats.totalRevenue || 0)}
              </p>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-all">
              ...
              <p className="text-3xl font-bold text-gray-900 mt-2">
                {displayOrderStats.totalOrders || 0}
              </p>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-all">
              ...
              <p className="text-3xl font-bold text-gray-900 mt-2">
                {displayProductStats.totalProducts || 0}
              </p>
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {sampleOrderStats.adminRevenue.map((admin, index) => (
          ...
          <motion.div variants={itemVariants}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-all">
                ...
                <p className="text-3xl font-bold text-gray-900 mt-2">
                  {displayOrderStats.ordersByStatus.pending || 0}
                </p>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-all">
                ...
                <p className="text-3xl font-bold text-gray-900 mt-2">
                  {displayOrderStats.ordersByStatus.processing || 0}
                </p>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-all">
                ...
                <p className="text-3xl font-bold text-gray-900 mt-2">
                  {displayOrderStats.ordersByStatus.confirmed || 0}
                </p>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-all">
                ...
                <p className="text-3xl font-bold text-gray-900 mt-2">
                  {displayOrderStats.ordersByStatus.shipped || 0}
                </p>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-all">
                ...
                <p className="text-3xl font-bold text-gray-900 mt-2">
                  {displayOrderStats.ordersByStatus.delivered || 0}
                </p>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-all">
                ...
                <p className="text-3xl font-bold text-gray-900 mt-2">
                  {displayOrderStats.ordersByStatus.cancelled || 0}
                </p>
