...
export const addProductFormElements = [
  ...
  },
  {
      ...
      dynamicOptions: true,
      options: [
          { id: "shirts", label: "Shirts", categories: ["men", "women"] },
          { id: "jeans", label: "Jeans", categories: ["men", "women"] },
          { id: "dresses", label: "Dresses", categories: ["women"] },
          { id: "suits", label: "Suits", categories: ["men", "women"] },
          { id: "t-shirts", label: "T-Shirts", categories: ["men", "women", "kids"] },
          { id: "activewear", label: "Activewear", categories: ["men", "women", "kids"] },
          { id: "underwear", label: "Underwear", categories: ["men", "women", "kids"] },
          { id: "shoes", label: "Shoes", categories: ["footwear"] },
          { id: "sneakers", label: "Sneakers", categories: ["footwear"] },
          { id: "boots", label: "Boots", categories: ["footwear"] },
          { id: "sandals", label: "Sandals", categories: ["footwear"] },
          { id: "bags", label: "Bags", categories: ["accessories"] },
          { id: "watches", label: "Watches", categories: ["accessories"] },
          { id: "jewelry", label: "Jewelry", categories: ["accessories"] },
